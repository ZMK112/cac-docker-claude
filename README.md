...
```text
ghcr.io/zmk112/claude-docker:v0.1.29
```
...
```bash
PKG_VERSION=v0.1.29 bash scripts/package-source.sh
```

Upload these files to the GitHub release:

```text
dist/cac-docker-claude-source-v0.1.29.zip
dist/cac-docker-claude-source-v0.1.29.sha256
