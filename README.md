...
```text
ghcr.io/zmk112/cac-docker-claude:v0.1.10
```
...
```bash
PKG_VERSION=v0.1.10 bash scripts/package-source.sh
```

Upload these files to the GitHub release:

```text
dist/cac-docker-claude-source-v0.1.10.zip
dist/cac-docker-claude-source-v0.1.10.sha256
